...
export default function ContactPage() {
    return (
        <div className="mx-auto py-8">
            ...
            <div className="w-[100vw] max-w-[100vw] ml-[calc(-50vw+50%)] overflow-x-hidden px-[7px]">
                <div className="w-[92%] sm:w-[88%] max-w-[var(--container-width)] mx-auto relative mt-23 mb-12 p-2 sm:p-[25px] bg-gradient-to-r from-blue-500 to-blue-100 rounded-2xl sm:rounded-4xl">
                    <Image
                    ...
                    <div className="max-w-3xl mx-auto bg-white relative p-6 rounded-lg shadow-sm z-[1]">
                        <p className="text-gray-700 mb-6">
                            Есть вопросы, предложения или просто хотите
                            поговорить о Java-разработке? Заполните форму ниже,
