...
const BASE_URL = "http://ec2-51-21-195-168.eu-north-1.compute.amazonaws.com/wp-json/wp/v2";
...
export async function sendContactForm(
    ...
    try {
        ...
        const response = await fetch(
            `http://ec2-51-21-195-168.eu-north-1.compute.amazonaws.com/wp-json/contact-form-7/v1/contact-forms/${formId}/feedback`,
            {
                method: "POST",
                body: formData,
            }
